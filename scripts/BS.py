...
class Device:
    ...
    def send_message(self,link,message:Packet): # sends message of type Packet to given node
        if link not in self.links:
            ...
            return True
    ############################
    def encrypt(self,message,key): # encrypts, returns tag, nonce and ciphertext
...
class BS(Device):
    ...
    def create_auth_messages(self): # returns a list of aggregate path messages
...
if __name__ == "__main__":
    ...
    print("PATHS : ",bs.paths)
    print("PATH lINKS : ",bs.starting_links)
    print("Generating Authentication messages")

    # auth message creation
    auth_message = bs.create_auth_messages() # auth message is a list that contains aggregate path messages as items
    
    print("AUTH message created")
